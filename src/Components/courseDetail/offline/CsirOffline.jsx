    ...
    return (
        <div className='online'>
            ...
            <ul>
                ...
                <li> • <h6>Conceptual Clarity:</h6> We emphasize developing strong conceptual and numerical abilities, helping students build a solid foundation in chemical sciences.</li>
                <li> • <h6>Comprehensive Study Materials:</h6> Our meticulously crafted study materials are designed to reinforce your understanding of the subject and include practice questions and mock tests to assess your progress.</li>
                <li> • <h6>Regular Topic-wise Tests:</h6> To track your performance, we conduct regular topic-wise tests, followed by in-depth discussions. This iterative approach helps students improve and master the subject.</li>
                <li> • <h6>Time Management:</h6> Our course is meticulously planned under a time management method to maximize knowledge transfer in a limited time period.</li>
