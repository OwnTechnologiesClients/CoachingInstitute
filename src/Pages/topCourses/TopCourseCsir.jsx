    ...
    <div className="top-courses">
      ...
      <div className="container-123">
        ...
        <section id="why-asap">
          ...
          <ul>
            ...
            <li>
              ...
              requires consistent practice. Our program includes a wide range of
              practice materials, including mock tests and a comprehensive test
              series, to help you sharpen your problem-solving skills and gain
              confidence.
            </li>
            <li>
            ...
            <li>
              ...
              designed to simulate the actual exam environment, allowing you to
              gauge your progress, identify areas for improvement, and fine-tune
              your exam strategy.
            </li>
          </ul>
        </section>
        ...
        <section id="deliverables">
          ...
          <ol>
            <li>
              <strong>Offline Coaching:</strong> Attend classes at our center in
              Delhi with options for both Regular and Weekend batches.
            </li>
            <li>
              <strong>Online Live Classes:</strong> Join our Regular Morning and
              Evening batches or opt for weekend classes for the flexibility to
              learn from anywhere.
            </li>
            <li>
              <strong>Online Recorded Courses:</strong> Access recorded lectures
              at your convenience, allowing for Self-paced learning.
            </li>
            <li>
              <strong>Study Material:</strong> Our high-quality study materials
              are designed to enhance your understanding of critical concepts
              and aid in effective exam preparation.
            </li>
            <li>
        ...
        <section id="enrollment">
          <p>
            ...
            CSIR-NET/JRF. Our commitment is to empower your dreams and help you
