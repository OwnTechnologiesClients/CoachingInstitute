...
const ReactJsOnline = () => {
  ...
  return (
    <div className='online'>
      ...
      <p>We offer India's best Reactjs online course with a job-ready curriculum, project work, a completion certificate, and a guaranteed 3-month internship.</p>
