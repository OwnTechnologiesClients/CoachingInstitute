    ...
    return (
        <div className='online'>
            ...
            <ul>
                ...
                <li> • <h6>Effective Teaching Methods:</h6> We employ a diverse range of teaching techniques, encompassing lectures, problem-solving sessions, and interactive discussions to make the learning process engaging and fruitful.</li>
                <li> • <h6>Regular Practice:</h6> Practice is the cornerstone of success in the GATE exam. We offer a plethora of practice questions, quizzes, and mock tests to help you hone your problem-solving skills and boost your confidence.</li>
                <li> • <h6>Quality Study Materials:</h6> Our study materials are thoughtfully designed to complement your classroom learning. They are curated to facilitate a better understanding of complex topics.</li>
                <li> • <h6>Unique Teaching Approaches:</h6> At ASAP Institute, we recognize that each student is unique. Our educators adopt a flexible teaching approach that caters to your specific learning style.</li>
            ...
            <ol>
                ...
                <li>
                    <p><h6>Q2: What are the benefits of taking the GATE Chemistry exam?</h6></p>
                ...
                <li>
                    ...
                    <p><h6>A:</h6> The duration of the GATE Chemistry Offline Course at ASAP Institute varies to cater to different preferences. We offer two options:
                        <ul>
                            ...
                            <li><h6>GATE Chemistry Offline Classes (1 Year - Weekend):</h6> If you are looking for a more extended preparation period, our one-year weekend course is perfect. It allows you to balance your studies with other commitments, making it convenient for working professionals or students with busy schedules.</li>
                        </ul>
                    </p>
                </li>
                <li>
