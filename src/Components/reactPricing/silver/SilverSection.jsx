...
const SilverSection = () => {
  ...
  return (
    <main className="react-silver-price-container">
      <div className="price-template">
        ...
        <section className="col-section">
          <div className="value">
            <span className="right-value">₹ 1,625 / Month</span>
            <span className="left-value">₹ 4,625</span>
          </div>

          <Link to='https://rzp.io/l/EFHiwJgtn' target="_blank">
          ...
          <div className="tags">
            <div className="img-text">
              <img src={Tick} alt="" />
              <p>Amazon, Oyo, Airbnb & multiple projects </p>
            </div>
            {/* <p className="inr">₹ 6999</p> */}
          </div>
          <div className="tags">
