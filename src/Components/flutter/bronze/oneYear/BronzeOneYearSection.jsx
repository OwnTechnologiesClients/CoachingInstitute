...
const BronzeOneYearSection = () => {
  ...
  return (
    <main className="flutter-price-container">
      <div className="price-template">
        ...
        <section className="col-section">
          <div className="value">
            <span className="right-value">₹ 2,749 / Month</span>
            <span className="left-value">₹ 4,749</span>
          </div>

          <Link to='https://rzp.io/l/cK3rOYyTOf' target="_blank">
...
export default BronzeOneYearSection;
