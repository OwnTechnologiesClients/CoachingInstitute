    ...
    return (
        <div className='online'>
            ...
            <ol>
                ...
                <li><h6>Q3: How can I enroll in the CUET(PG) Chemistry coaching at ASAP Institute?</h6><br /><h6>A:</h6> Refer to the registration Process.</li>
                <li><h6>Q4: What is the course fee payment process for CUET(PG) Chemistry coaching?</h6><br /><h6>A:</h6> Refer to the registration Process.</li>
                <li><h6>Q5: What are the duration options for the CUET(PG) Chemistry coaching at ASAP Institute?</h6><br /><h6>A:</h6> Our program offers two durations - a six-month, regular course, and a one-year, weekend course. Choose the one that best aligns with your learning preferences and schedule.</li>
                <li><h6>Q6: What postgraduate courses does CUET(PG) Chemistry cover?</h6><br /><h6>A:</h6> CUET(PG) Chemistry serves as the common entrance test for a wide range of postgraduate programs offered by central universities in India. It includes M.Sc. programs in Chemistry and related fields.</li>
                <li><h6>Q7: Is it essential to enroll in coaching for CUET(PG) Chemistry, or can I prepare independently?</h6><br /><h6>A:</h6> While self-study is possible, enrolling in professional coaching can significantly enhance your preparation. Our expert faculty, quality study materials, and practice resources will provide a structured approach and better guidance to excel in the examination.</li>
                <li><h6>Q8: What makes ASAP Institute's CUET(PG) Chemistry coaching stand out from the rest?</h6><br /><h6>A:</h6> At ASAP Institute, our distinguished faculty, comprehensive syllabus coverage, effective teaching methods, and regular assessments set us apart. We offer flexibility in terms of course duration, and our quality study materials are tailored to facilitate better understanding of complex topics.</li>
                <li><h6>Q9: Are there any mock tests or practice materials included in the CUET(PG) Chemistry coaching program?</h6><br /><h6>A:</h6> Yes, we provide mock tests, practice questions, and quizzes as part of the course. These are crucial for honing your problem-solving skills and overall preparation for CUET(PG).</li>
                <li><h6>Q10: What is the success rate of students who enroll in CUET(PG) Chemistry coaching at ASAP Institute?</h6><br /><h6>A:</h6> Our coaching is designed to provide you with the best preparation. The success rate depends on various factors, including your dedication, commitment, and consistency in your preparation. We aim to equip you with the knowledge and skills needed to succeed in CUET(PG).</li>
            </ol>

            <p>Join our CUET(PG) Chemistry coaching at ASAP Institute and pave your way to academic excellence.</p>

        </div>
    )
}

export default CuetOffline