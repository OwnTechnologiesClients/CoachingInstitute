    ...
    return (
        <div className='online'>
            ...
            <ul>
                ...
                <li> • <h6>Access to Recorded Content:</h6> We understand that flexibility is key. For this reason, we offer recorded lectures for our online batch students. This accessibility enables you to tailor your learning experience according to your convenience. You can revisit lectures and study at your own pace, making the most of your study time.</li>
                <li> • <h6>Practice and Assessments:</h6> Success in the CUET(PG) Chemistry exam is achieved through practice. Our course provides a wide array of practice materials, including questions, quizzes, and mock tests. These valuable resources are designed to help you refine your problem-solving skills and evaluate your progress.</li>
            ...
            <ol>
                ...
                <li><h6>Q3: Are the recorded lectures accessible at any time?</h6><br /><h6>A:</h6> Yes, for the CUET(PG) Chemistry Online Batch with recorded content (6 months, 1 year, and 2 years), you can access the recorded lectures at your convenience. This flexibility empowers you to learn at your own pace, reinforcing your comprehension of complex topics.</li>
                <li><h6>Q4: What is the advantage of the weekend batch for working professionals and students?</h6><br /><h6>A:</h6> Our 1-year weekend batch is specifically designed to accommodate the schedules of working professionals and students. It allows you to attend live online classes during weekends, offering flexibility without compromising the quality of education.</li>
                <li><h6>Q5: How do I access practice materials and assessments for CUET(PG) Chemistry preparation?</h6><br /><h6>A:</h6> Upon enrollment, you will gain access to our comprehensive collection of practice questions, quizzes, and mock tests. These resources are readily available to help you enhance your problem-solving skills and monitor your progress.</li>
                <li><h6>Q6: Can I switch from one batch to another during my enrollment?</h6><br /><h6>A:</h6> Our enrollment process is designed to cater to your needs. While switching between batches may be feasible, it is subject to availability and approval. We recommend discussing your requirements with our team for a seamless transition.</li>
                <li><h6>Q7: How does the recorded content benefit CUET(PG) Chemistry aspirants?</h6><br /><h6>A:</h6> Recorded content serves as a valuable resource for students who prefer self-paced learning. It empowers you to revisit lectures and study materials at your convenience, strengthening your grasp of complex topics.</li>
            </ol>
